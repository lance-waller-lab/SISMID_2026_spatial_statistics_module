---
title: "Waller SISMID 2026:  Houston Crime Spatially Varying Slopes"
...
here::i_am("Waller.Houston.GWR.SlipperySlopes.SISMID2026.Rmd")
...
houston$violence = houston$violence_2
```

Divide by the 2000 population to get the rate
```{r}
#violence.rate = violence/houston$tot_pop
houston$violence.rate = houston$violence/houston$tot_pop
```
...
```{r}
# Look at all 9 hex codes in BuPu within ColorBrewer palette
...
These are very smooth maps.   Let's try it with a smaller bandwidth (1/4 the size of the previous bandwith). This yields maps closer to what is presented in Figure 5 of Waller et al. 2007
